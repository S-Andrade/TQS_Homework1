...
public class WeatherResourceTest {
    ...
    public void testGetWindSpeed() {
        ...
        when(instance.todoDAO.getWindSpeed()).thenReturn(ws);
    ...
    public void testGetAllDistrict() {
        ...
        when(instance.todoDAO.getDistricts()).thenReturn(dt);
    ...
    public void testGetWeatherForecast() {
        ...
        when(instance.todoDAO.getWeatherForecastByDistrict(instance.todoDAO.translateDistrict("Lisboa"))).thenReturn(wf);
    ...
    public void testGetAllWeather() {
        ...
        when(instance.todoDAO.getWeather()).thenReturn(wd);
    ...
    public void testGetCacheStats() {
        ...
        Response expResult = Response.ok(wd).build();
        when(instance.todoDAO.getCacheStats()).thenReturn(wd);
