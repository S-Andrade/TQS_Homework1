<%-- 
    Document   : weather
    Created on : 2/mai/2019, 15:41:14
    Author     : ana
--%>

<%@page import="ua.pt.restapi.models.DistrictData"%>
    ...
    <body>
        <div class="container-fluid">
            ...
            <div>
                ...
                <table class="table-responsive-sm table-bordered text-center">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        <c:forEach items="${districtData}" var="district" >
                            <tr>
